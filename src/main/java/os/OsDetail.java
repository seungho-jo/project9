...
public class OsDetail {
	...
	public OsDetail(String oscode, String id, String title, String category, String ftf, String loc, String budget,
			String datepicker, String taxinvoice, String explain, String osfile, String profile, String name) {
		super();
		this.oscode = oscode;
		this.id = id;
		this.title = title;
