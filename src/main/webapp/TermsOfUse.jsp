...
<textarea rows="30" cols="161">
	제 1 장 총칙
제 1 조 (목 적)
이 약관은 이용자가 주식회사 브레이브모바일(이하 “회사”)이 운영하는 인터넷 서비스 사이트(이하 “사이트” 또는 “오늘의 수업”)를 통해 제공하는 인터넷 전자상거래 관련 서비스(이하 “서비스”)와 관련하여 회사와 이용자의 권리, 의무, 책임사항을 규정함을 목적으로 합니다. 또한 본 약관은 유무선 PC통신, 태블릿 PC, 스마트폰(아이폰, 안드로이드폰 등) 어플리케이션 및 모바일웹 등을 이용하는 전자상거래 등에 대해서도 그 성질에 반하지 않는 한 준용됩니다.
본 약관이 규정한 내용 이외의 회사와 이용자 간의 권리, 의무 및 책임사항에 관하여서는 전기통신사업법 기타 대한민국의 관련 법령과 상관습에 의합니다.
제 2 조 (정 의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.

회사가 운영하는 사이트는 아래와 같습니다.
todayclass.com, 추후 회사에서 공지하고 제공하는 기타 웹사이트, 스마트폰 및 이동통신기기를 통해 제공되는 모바일 어플리케이션 포함
이용자: 오늘의 수업에 접속하여 이 약관에 따라 서비스를 받는 회원 및 비회원을 말합니다.
회원: 본 약관에 따라 회사와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여받아 회사가 제공하는 서비스를 이용하는 개인을 말합니다. 회원은 이용하는 서비스에 따라 고객과 고수 회원으로 나누어집니다.
고객: 회사에 개인정보를 제공하여 회원등록을 한 자로서, 회사와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여 받아 사이트 내에 게시된 광고를 열람하거나 요청서를 작성하고 고수 회원에게 요청서를 보내는 등 원하는 용역의 고수를 찾기 위해 사이트를 계속적으로 이용할 수 있는 자를 말합니다.
고수 회원: 회사에 개인정보를 제공하여 회원등록을 한 자로서, 회사와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여 받아 고객에게 견적을 보낼 수 있고 오늘의 수업 캐시를 구매하는 등 고객을 찾기 위한 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
요청서: 요청자가 원하는 용역에 대한 구체적인 정보를 담고 있는 서비스 요청서입니다.
견적(견적서): 고수 회원이 자신이 제공할 수 있는 용역에 관하여 요청자에게 보낼 수 있는 용역 금액 및 내용에 대한 요약본입니다.
오늘의 수업 캐시: 회원이 견적 발송, 즉 서비스를 사용하기 위해 구매하는 사이버 머니를 의미합니다. 오늘의 수업 캐시는 충전 캐시와 보너스 캐시로 구성되며, 오늘의 수업 캐시의 사용 순서는 회사가 정하는 정책에 따릅니다.
...
콘텐츠(Contents): 회사가 오늘의 수업에서 제공하는 정보, 요청서 작성, 견적 작성, 요청서 수신, 견적 수신, 프로그램 등 부호ㆍ문자ㆍ도형ㆍ색채ㆍ음성ㆍ음향ㆍ이미지ㆍ영상 및 복합체의 정보나 자료를 의미합니다.
...
비회원: 회원에 가입하지 않고 서비스를 이용하는 자로 오늘의 수업 이용자 및 정보의 수신을 위해 전자우편 및 SMS 서비스를 온라인 또는 서면으로 신청한 자를 지칭합니다.
회원 탈퇴: 회원이 이용계약을 종료시키는 행위를 말합니다.
뉴스레터(Newsletter): 회사가 보내는 오늘의 수업 소식이 담긴 이메일을 의미합니다.
안전거래서비스: 서비스로서, 회원 상호 간의 금전 거래를 안전하고 용이하게 하기 위하여 회사가 제공하는 서비스를 의미합니다.
인터랙션 : 회원간의 채팅, 전화 등 오늘의 수업에서 제공하는 방식을 통해 상호작용 할 수 있는 행위를 의미 합니다.

제 3 조 (약관의 명시, 효력 및 개정)
회사는 이 약관의 내용과 주소지, 관리자의 성명, 개인정보보호 담당자의 성명, 연락처(전화, 팩스, 전자우편 주소 등) 등을 이용자가 알 수 있도록 오늘의 수업의 초기 서비스 화면에 게시합니다. 다만, 약관의 구체적 내용은 이용자가 연결화면을 통하여 볼 수 있습니다.
이 약관은 그 내용을 오늘의 수업에 게시하거나 이메일 등 기타의 방법으로 회원에게 공지함으로써 효력이 발생합니다.
...
오늘의 수업 서비스 이용은 사이트의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다.
회사가 오늘의 수업에서 제공하는 서비스는 기본적으로 무료입니다. 단, 별도로 고수 회원이 고객에게 견적을 보내는 등 일부 특정 서비스를 이용하기 위해서는 회사로부터 구매하거나 무상으로 제공받은 오늘의 수업 캐시를 사용하여야만 해당 서비스를 이용 가능합니다.
...
제 12 조 (회원탈퇴 및 자격상실)
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 오늘의 수업 내의 메뉴 또는 전화 등의 방법을 이용하여 가입해지를 신청할 수 있으며, 회사는 즉시 회원 탈퇴 처리를 합니다.
...
제1호 내지 제3호 기타 부정한 방법으로 오늘의 수업 캐시를 적립, 사용한 경우
...
회사가 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 소명할 기회를 부여합니다.
	...
	제 4 장 오늘의 수업 캐시 사용 및 보상
제 13 조 (오늘의 수업 캐시 사용 및 보상)
오늘의 수업 캐시는 회사가 제공하는 서비스를 사용할 때 지불 수단으로 이용될 수 있습니다.
오늘의 수업 캐시는 보상이 필요할 경우 오늘의 수업 서비스 내에서 유료 결제 서비스마다 보상 정책에 대한 안내를 할 수 있습니다.

제 14 조 (견적 발생 비용)
고수 회원은 고객이 작성한 요청서를 열람하고, 고객에게 자신이 제공할 수 있는 용역에 대한 견적을 발송할 수 있습니다. 고객이 작성한 요청서의 유효기간은 48시간이며, 해당 시간 내에 견적을 발송할 수 있습니다.
견적 발송은 유료이며, 고수 회원은 회사가 제시하는 견적 발송 서비스 대금을 결제하고 견적 발송 서비스를 이용할 수 있습니다. 견적 발송에 대한 대금은 오늘의 수업 캐시로 지급하여야 합니다.
...
견적이 발송된 이후 48시간동안 해당 견적에 대해 고객이 아무런 반응이 없을 경우 (견적이 전달된 채팅방에 진입하지 않았을 때), 고수 회원은 견적 발송에 지급된 비용을 보너스 캐시로 보상받을 수 있습니다.
	...
	제 5 장 지급 수단
제 16 조 (오늘의 수업 캐시의 구매 및 환불)
고수 회원은 견적 발송 및 고객과의 추가 인터랙션을 사용하기 위하여 오늘의 수업 캐시를 구입할 수 있습니다. 견적 발송 시 고수 회원의 지역과 제공 서비스에 따라 차등 산정되는 견적 발송 비용에 비례하여 오늘의 수업 캐시 스토어 상품군 내역이 보여지게 됩니다.
고수 회원은 충전 캐시를 구매 후 지급받은 날로부터 5년 간 미사용 오늘의 수업 캐시에 대하여 환불을 요청하고, 해당 충전 캐시를 구매하기 위해 지급한 대금 전액을 환불받을 수 있습니다.
...
제1항 또는 제5항에 의한 오늘의 수업 캐시 환불 시 해당 오늘의 수업 캐시 구매에 대한 혜택으로 회사가 고수 회원에게 무상으로 제공한 오늘의 수업 포인트는 전액 소멸됩니다.
고수 회원이 구매한 충전 캐시는 고수 회원이 오늘의 수업에 2년 이상 접속하지 않을 경우 일괄 삭제됩니다.
회원의 등록정보가 허위 정보로 판명되거나 가입 조건 서비스 이용 조건에 부합되지 않는 점이 판명될 경우 징계 및 강제 탈퇴가 되며 회원 본인의 귀책사유로 인해 환불 및 보상이 불가능합니다.
회원이 자진탈퇴로 인해 계약이 해지되는 경우, 회원이 보유한 아이템은 자동으로 소멸되어 복구 및 환불이 불가능합니다.

제 17 조 (보너스 캐시)
고수 회원은 오늘의 수업 캐시 구매에 대한 혜택으로 회사로부터 오늘의 수업 캐시와 같이 오늘의 수업 서비스 결제 수단으로 사용할 수 있는 보너스 캐시를 지급받을 수 있습니다. 고수 회원은 보유하고 있는 충전 캐시를 모두 사용한 경우에만 보너스 캐시를 사용할 수 있습니다.
보너스 캐시는 회사가 고수 회원에게 무상으로 제공하는 혜택으로 금전으로 환불이 불가하며, 고수 회원이 오늘의 수업에 90일 이상 접속하지 않을 경우 일괄 삭제 됩니다. 회사는 보너스 캐시 소멸일로부터 1개월 전에 이메일 등을 통하여 고수 회원에게 보너스 캐시가 소멸 예정임을 통지 합니다.

제 18 조 (오늘의 수업 캐시 대금지급방법)
고수 회원은 오늘의 수업 캐시의 구매에 대한 대금을 다음 각 호의 방법 중 회사가 정하는 방법으로 지급합니다.
신용카드 (간편)결제
휴대전화 (간편)결제
선불카드
실시간 계좌이체
...
- 오늘의 수업 직원 및 관리자 또는 제3자를 사칭하는 행위
- 욕설, 비/속어 등을 사용하는 행위
- 다른 이용자에게 불쾌감이나 성적 수치심을 줄 수 있는 명칭을 사용하는 행위
...
회원의 귀책사유에 따른 이용계약의 해제·해지시 잔여 보너스 캐시는 소멸합니다. 잔여 충전 캐시가 있을 경우 회사는 회원가입시 회원이 입력한 연락처로 최소 30일의 기간을 두고 잔여 오늘의 수업 캐시 환불을 위한 계좌정보 등을 입력할 것을 최고합니다. 회원이 최고 기간 내 환불을 위한 정보를 입력하지 않을 경우 잔여 오늘의 수업 캐시는 소멸합니다. "
회사가 제19조 제2항에 따라 서비스 이용계약을 해제 또는 해지한 경우 회사는 회원에게 손해배상을 청구할 수 있습니다. 다만, 회원이 고의 또는 과실 없음을 증명한 경우에는 그러하지 않습니다.
	
	제 7 장 안전거래서비스
제 22 조 (안전거래서비스)
회사는 고수 회원과 고객이 서비스를 이용함에 있어 안전하고 편리한 금전 거래를 위하여 대금의 수령, 보관 및 송금업무로 이루어지는 에스크로 방식의 안전거래서비스를 제공합니다.
안전거래 진행 여부에 대한 동의를 하고, 안전거래를 위한 계좌를 등록한 고수 회원에 한하여 안전거래 서비스를 이용할 수 있습니다.
각 거래에 대한 안전거래서비스는 고수 회원 또는 고객의 요구에 따라 개시됩니다. 고수 회원은 거래금액과 예상 서비스이행완료일을 포함한 최종 안전거래 내용을 발송하며, 고객은 서비스에 대한 수수료 안내를 받은 뒤 수수료와 거래금액을 합한 대금을 안전거래서비스에 입금합니다.
회사는 안전거래서비스를 통해 고객이 입금한 대금을 보관합니다. 고수 회원이 서비스를 이행한 이후 고객이 서비스 상 거래 확정 버튼을 클릭하는 방식으로 거래 확정을 하면 회사는 보관하는 대금 중 수수료를 제외한 거래금액을 고수 회원에게 지급합니다.

제 23 조 안전거래서비스 계좌 등록
고수 회원은 안전거래서비스를 위하여 자신이 용역 대금을 수령할 계좌를 지정하여 올바른 정보를 입력하여야 합니다.
고수 회원이 입력한 계좌의 예금주는 고수 회원이 실명확인을 하여 가입할 때 동일인임을 원칙으로 합니다.

제 24 조 안전거래서비스 이용료 등
오늘의 수업안전거래서비스를 이용하기 위한 이용료는 유료가 원칙이며 회사는 안전거래서비스 이용료를 안전거래서비스 안내페이지에 안내합니다. 안전거래서비스에 대한 이용료는 고객이 부담합니다.
대금 송금 또는 결제로 인하여 별도의 수수료가 발생할 경우 해당 수수료는 대금을 송금하는 회원(고객)이 부담하여야 합니다.
안전거래서비스에 이미 고객이 이용료를 포함한 대금을 지급하였으나 계약이 파기된 경우 회사는 고객에게 이용료를 제한 거래금액만을 반환합니다. 자세한 반환에 대한 규정은 회사의 별도 규정에 따릅니다.

제 25 조 예치금의 지급
회사는 고객이 거래 확정을 하면 바로 대금을 고수 회원에게 지급하는 것을 원칙으로 합니다. 다만 금융기관 또는 전기통신사업자의 귀책 등 회사의 귀책사유가 없는 사유로 지급이 늦어질 수 있습니다.
고객은 고수 회원이 용역 이행을 완료하였을 때 지체 없이 거래 확정을 하여 고수에게 대금이 원활히 지급될 수 있도록 하여야 합니다.
고객이 다음과 같이 정당한 사유 없이 거래 확정 의무를 다하지 않는 경우 회사는 고객이 거래 확정하였다고 간주하고 대금을 지급하고 관련 절차를 진행할 수 있습니다.
고수 회원이 용역 이행을 완료하였음을 고지하였음에도 고객이 10일 이상 고수 회원이나 회사의 연락에 응하지 아니하는 경우
고수 회원이 용역 이행을 완료하여 이를 고지하였고 고객이 이를 확인하였음에도 고객이 해당 확인 일자로부터 10일 이상 거래 확정을 하지 아니하는 경우
기타 고객이 정당한 사유없이 거래확정을 아니하여 회사가 거래 확정처리를 하는 경우

제 26 조 안전거래서비스에 대한 회사의 면책
안전거래서비스는 고수 회원과 고객 간의 거래의 안전과 신뢰성 향상을 위한 목적에서 회사가 제공하는 서비스의 일환이므로 회사는 안전거래서비스를 이용하는 양 당사자 간의 거래에 어떠한 책임도 지지 않습니다.
회사는 안전거래서비스를 이용하는 고수 회원과 고객 중 어느 일방을 대리, 대행하거나 그 이행을 보조하는 위치에 있지 아니합니다.
안전거래를 위하여 잘못된 정보를 입력하여 잘못된 대금지급이 이루어졌을 경우 회사는 이에 대하여 책임지지 않습니다.
회사는 양 당사자간의 거래에 대하여 책임을 부담하지 아니하며 특히 고객의 거래 확정으로 거래가 승인된 이후 발생한 분쟁에 대하여 책임지지 않습니다. 거래 확정 후 대금의 지급이 완료된 이후 발생한 분쟁 또는 불만 사항은 양 당사자가 협의를 통해 해결해야 합니다.

	제 8 장 개인 정보의 처리
제 27 조 (회원의 개인정보 보호)
회사는 회원의 개인정보를 보호하기 위하여 정보통신망법 및 개인정보 보호법 등 관계 법령에서 정하는 바를 준수하며 이용자의 개인 식별이 가능한 개인정보를 수집하는 때에는 반드시 당해 이용자의 동의를 받습니다.
회사의 개인정보 보호는 오늘의 수업 개인정보처리방침에 따릅니다.
...
제1호 내지 제12호 기타 부정한 방법으로 오늘의 수업 캐시를 적립, 사용한 경우
...
타 회원들에게 허위사실을 유포하거나 표시광고를 위반하는 경우(견적에 회사에 상당한 수수료를 지불하고 있어, 절대 채팅으로 답변하지 말라는 내용을 기재하거나, 명함에 오늘의 수업 로고를 무단으로 표시하고 자신을 오늘의 수업협력사로 소개하는 등을 포함함): 모든 기능 사용 정지(영구 제재)
...
고수 회원은 견적을 수령한 고객과의 오늘의 수업 서비스에서 제공하는 메시지 기능이나 전화 등 별도의 연결수단을 통하여 세부사항을 조정할 수 있습니다. 회사는 견적 발송 이후 고수 회원과 고객 간에 발생한 일체의 문제에 대하여 어떠한 책임도 지지 않습니다.

제 32 조 (회원의 ID 및 비밀번호에 대한 의무)
...
이용계약이 해지되는 경우 회원의 개인 페이지 내 회원이 게시한 게시물은 삭제됩니다.
이용 계약이 해지되는 경우에도 “다른 회원 또는 제3자에게 의하여 스크랩, 공유 등의 기능을 통해 다시 게시된 게시물” 및 “댓글 등 다른 회원의 정상적인 서비스 이용에 필요한 게시물”은 삭제되지 않습니다. 단, 작성자를 식별할 수 있는 개인 정보는 게시물에서 삭제됩니다.

제 34 조 (저작권의 귀속 및 권리, 의무)
...
제 35 조 (광고주 및 연결 사이트와의 관계)
회사의 공식 사이트 이외의 웹사이트 및 이메일에서 링크된 사이트에서는 회사의 개인정보 보호정책 및 본 약관이 적용되지 않습니다.
회사는 오늘의 수업 사이트 또는 e-mail 상에 게재되어 있거나 본 서비스를 통한 광고주의 판촉활동에 회원이 참여하거나 교신 또는 거래를 함으로써 발생하는 손실과 손해에 대해 책임을 지지 않습니다.
...
회사는 회원들에게 요청서와 견적을 전달하거나 광고플랫폼 또는 안전거래서비스를 제공하고 이에 대한 부수적인 서비스를 제공할 뿐이므로 회원 상호 간 서비스를 매개로 하여 거래를 한 경우 이용자 각자의 의무이행에 대한 책임은 각 이용자에게 있으며 회사는 이에 대한 책임이 없습니다.
회사는 회원들에게 요청서와 견적을 전달하거나 광고플랫폼 또는 안전거래서비스를 제공하고 이에 대한 부수적인 서비스를 제공할 뿐이므로 고수와 요청자 간 거래와 관련하여 발생한 의무의 불완전 이행, 이행 지체 등 용역 이행 미비, 사후처리, 대금 정산, 완성품의 하자, 청약철회, 물품의 반품 등 어떠한 법적 분쟁 및 사후처리에 대해서도 개입하거나 책임지지 않습니다.
...
제 42 조 (추가 약관 및 정책)
오늘의 수업 보증에 대한 약관은 ‘오늘의 수업 보증 약관’에서 확인할 수 있습니다.
부칙

제1조 (시행일) 이 약관은 2021년 6월 30일부터 시행합니다.
</textarea>
</body>
</html>